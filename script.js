...
class MyFooter extends HTMLElement{
    ...
    <div>
      <p class='text-center m-4 text-white'>© 2025 Pradhan Eye Hospital. All Rights Reserved. | <a href='https://evolve-web-solapur.vercel.app/' target="_blank" class="hover:underline text-sky-300 font-secondary">Design By Evolve Web Solapur</a></p>
    </div>
